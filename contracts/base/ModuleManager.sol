...
/// @title Module Manager - 可以通过 某个 Module 合约 直接执行交易
contract ModuleManager is SelfAuthorized, Executor {
    ...
    /// @dev 允许将模块添加到白名单 ,  为 Vault 启用模块 module  
    ...
    /// @dev 允许从白名单中删除模块 ,  为 Vault 禁用模块 `module` 
    ...
    /// @dev 允许模块在没有任何进一步确认的情况下 执行安全事务并返回数据 
    /// @param to 模块事务的目标地址  
    /// @param value 模块交易的以太币值  
    /// @param data 模块事务的数据负载  
    /// @param operation 模块事务的操作类型 
